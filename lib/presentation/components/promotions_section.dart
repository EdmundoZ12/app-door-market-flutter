...
class PromotionsSection extends StatefulWidget {
  const PromotionsSection({super.key, this.onProductTap});
...
class PromotionProductCard extends StatelessWidget {
  const PromotionProductCard({super.key, required this.product, this.onTap});
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(
                                    (product.popularity / 20).toStringAsFixed(
                                      1,
                                    ),
                                    style: const TextStyle(
                                      fontSize: 14,
